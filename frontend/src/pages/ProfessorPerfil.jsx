...
export default function ProfessorPerfil() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/professores/${userData.mongoId}`, {
        method: 'PATCH',
        headers: {
  ...
  return (
    <div className="perfil-container">
      <div className="perfil-header">
        <div className="perfil-avatar professor">
          <i className="fas fa-chalkboard-teacher"></i>
        </div>
        <div className="perfil-info">
          <h1>Prof. {userData?.nome}</h1>
            ...
            <div className="perfil-details">
              ...
              <div className="detail-item">
                ...
                <div>
                  ...
                  <span className="detail-value">{userData?.departamento}</span>
                </div>
              </div>
